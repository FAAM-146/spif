...
__all__ = ['get_std', 'get_version', 'get_vocab']
...
def get_version(std_path: str='.', product_version: str=None) -> tuple:
...
def get_vocab(std_path: str='.', vocab_types: [str, list]=None) -> Mapping:
